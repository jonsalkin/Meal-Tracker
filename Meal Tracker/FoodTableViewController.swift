...
class FoodTableViewController: UITableViewController {
    ...
    var meals: [Meal] {
        ...
        let firstLateSnack = Food(name: "Pizza", description: "Ordered on UberEats from whatever is open.")
        let secondLateSnack = Food(name: "Taco", description: "Usually from Taco Bell for late night renewal.")
        let thirdLateSnack = Food(name: "Sliders", description: "White Castle would be ideal from a briefcase.")
        let lateSnack = Meal(name: "Late Night Snack", food: [firstLateSnack, secondLateSnack, thirdLateSnack])
        
        return [breakfast, lunch, dinner, lateSnack]
    }
